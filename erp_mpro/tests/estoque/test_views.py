...
from erp_mpro.apps.cadastro.models import Produto
from erp_mpro.apps.estoque.models import LocalEstoque, DEFAULT_LOCAL_ID, ProdutoEstocado, EntradaEstoque, SaidaEstoque, TransferenciaEstoque
