...
from erp_mpro.tests.test_case import BaseTestCase, replace_none_values_in_dictionary
from erp_mpro.apps.cadastro.models import Fornecedor, Produto
from erp_mpro.apps.compras.models import OrcamentoCompra, PedidoCompra, ItensCompra
from erp_mpro.apps.estoque.models import LocalEstoque, DEFAULT_LOCAL_ID
