...
from erp_mpro.apps.fiscal.models import NotaFiscalSaida, NotaFiscalEntrada, ConfiguracaoNotaFiscal, AutXML, \
...
from erp_mpro.apps.cadastro.models import COD_UF, PessoaJuridica, PessoaFisica, Fornecedor, Cliente, Empresa, Transportadora, Endereco, Telefone, Produto, Unidade
from erp_mpro.apps.compras.models import PedidoCompra, ItensCompra
from erp_mpro.apps.vendas.models import PedidoVenda, ItensVenda

from erp_mpro.apps.vendas.models import Pagamento as PagamentoVenda
