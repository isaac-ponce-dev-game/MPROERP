...
from erp_mpro.apps.base.custom_views import CustomCreateView, CustomListView, CustomUpdateView

from erp_mpro.apps.fiscal.forms import GrupoFiscalForm, ICMSForm, ICMSSNForm, ICMSUFDestForm, IPIForm, PISForm, COFINSForm
from erp_mpro.apps.fiscal.models import GrupoFiscal, ICMS, ICMSSN, ICMSUFDest, IPI
