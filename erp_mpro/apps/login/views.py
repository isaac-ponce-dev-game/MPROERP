...
from erp_mpro.apps.base.views_mixins import SuperUserRequiredMixin

from .forms import UserLoginForm, UserRegistrationForm, PasswordResetForm, SetPasswordForm, PerfilUsuarioForm
from .models import Usuario
from erp_mpro.configs.settings import DEFAULT_FROM_EMAIL

from erp_mpro.apps.cadastro.forms import MinhaEmpresaForm
            ...
            if associated_user:
                try:
                    if associated_user.email:
                        ...
                        subject = u"Redefinir sua senha - erp_mpro"
